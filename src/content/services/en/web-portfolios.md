---
title: "Custom Web Portfolios & Landing Pages"
description: "Why are visitors leaving your site in seconds? How much is a slow, generic website costing your brand authority?"
icon: "laptop-code"
priority: 5
...
scopeItems:
  ...
  - title: "Personal & Corporate Portfolios"
    desc: "Writing clean, high-performance semantic code using Astro, React, and CSS variables."
...
faqItems:
  ...
  - q: "Will my website load quickly on mobile devices?"
    a: "Absolutely. I design with a strict 'Mobile-First' approach. Additionally, Astro automatically compiles pages to zero-JavaScript HTML and optimizes image sizes dynamically, guaranteeing a load speed under 1 second on mobile networks."
  - q: "Do you help with custom domain connection and hosting setup?"
    a: "Yes. I manage the entire deployment process, configuring your hosting environment (typically serverless systems like Netlify or Cloudflare) and linking your custom domain securely with SSL so your site is live and secure."
  - q: "What support do you provide after the website goes live?"
    a: "I offer 30 days of direct post-launch support to resolve any questions or issues, and perform basic updates. I can also integrate a lightweight content manager (CMS) if you need to edit portfolio items or articles on your own."
draft: false
featured: false
